...
const AllActiveIssuesListPage = require('./support/allIssuesList-page');
...
test.describe('Should be able to navigate', function() {
  ...
  test.describe('from home page', function() {
    ...
    test.it('to all active issues list page', function() {
      page = new IssuesListPage(this.driver);
      page.followAllActiveIssuesListLink();
    });
  ...
  test.describe("from issue page", function() {
    ...
    test.it("to all active issues page", function() {
      page.followIssue(1);
      this.driver.navigate().refresh();
      page.followAllActiveIssuesListLink();
    });
  });
  test.describe("from all active issues page", function() {
  ...
  test.it("home page -> issue -> more issues -> issue, and then back " +"through history to home page", function() {
    ...
    page = new IssuesListPage(this.driver);
    page = page.followAllActiveIssuesListLink();
    ...
    // Now go back to all active issues page
    goBackTo(driver => {return new AllActiveIssuesListPage(driver)});
